...
function TeacherAccountSettings() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (newPassword === confirmNewPassword && newPassword.length > 4) {
            const response = await fetch(`https://sasietdavv-backend.herokuapp.com/api/auth/changepassword`, {
                method: 'POST',
                headers: {
            ...
            <div className="w-[80%]">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="Enter Your Current Password" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="newPassword" type="password" placeholder="Enter Your New Password" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="confirmNewPassword" type="password" placeholder="Enter Your New Password" />
                    </div>
